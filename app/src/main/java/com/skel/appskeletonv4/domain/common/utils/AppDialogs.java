...
public class AppDialogs {
    ...
    /**
     * alert for approval send dialog
     * */
    public void showLogoutConfirmation(OnDualActionButtonClickListener listener){
     ...
     * */
    private void createDualActionAlertDialogBox(String message, boolean cancellable, String yesBtnName, String noBtnName, OnDualActionButtonClickListener listener){
        try{
            ...
            //init the dialog for the alert
            final Dialog dialog = createSimpleDialog(mContext, R.layout.dialog_dual_action_alert, false);

            //avoid closing dialog on clicking outside
            dialog.setCancelable(cancellable);

            //init the submit  button
            final AppCompatButton btn_yes = dialog.findViewById(R.id.btn_ok);
            final AppCompatButton btn_no = dialog.findViewById(R.id.btn_cancel);
